			...
			<div class="content">
				<div class="am-g">
					<!-- Row start -->
						<div class="am-u-sm-6">
							<div class="card-box">
								<h4 class="header-title m-t-0 m-b-30">寄件人</h4>
								<form action="/address/createAddress" class="am-form am-text-sm" >
										...
										<div class="am-g">
										    <div class="am-u-md-offset-9 am-u-md-3">
												<input type="hidden" name="Ptype" value="1"/>
										      	<button type="submit" id="submit-btn" class="am-btn am-btn-primary am-btn-block am-disabled">保存</button>
										    </div>
										</div>
									</div>
								</form>
